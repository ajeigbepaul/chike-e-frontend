  ...
  <section className="relative bg-[#232323] text-white py-16 px-4 sm:px-6 lg:px-8 overflow-hidden max-w-7xl mx-auto mt-10">
    ...
    <div className="hidden md:block">
      ...
      <div className="absolute -top-10 -right-10 w-40 h-40 rounded-full border-4 border-white overflow-hidden z-10">
        <Image src="/hero3.jpg" alt="Vendor 2" fill className="object-cover" />
      </div>
      {/* <div className="absolute left-1/2 -translate-x-1/2 bottom-0 translate-y-1/2 w-32 h-32 rounded-full border-4 border-white overflow-hidden z-10">
        <Image src="/feature2.jpg" alt="Vendor 3" fill className="object-cover" />
      </div> */}
    </div>
    {/* Content */}
    <div className="relative z-20 flex flex-col items-center text-center max-w-3xl mx-auto">
      <h2 className="text-3xl md:text-4xl font-bold text-brand-yellow mb-2">Partner With Us — Become a Vendor</h2>
      <h3 className="text-xl md:text-2xl font-semibold text-white mb-2">Showcase your products. Reach more customers. Grow your business.</h3>
      <p className="text-gray-200 text-base md:text-lg mb-8">Join our network of trusted suppliers and get your building materials in front of thousands of contractors, developers, and homeowners.</p>
      <button className="bg-brand-yellow text-gray-900 font-semibold px-10 py-3 rounded-full w-[50%] text-lg mb-10 hover:bg-yellow-500 transition">Start selling today!</button>
    </div>
    {/* Features */}

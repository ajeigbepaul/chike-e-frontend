...
const ProductsAdCard = () => (
  <div className="relative bg-[#232323] rounded-2xl flex flex-col md:flex-row items-center justify-between px-8 py-8  min-h-[180px] max-w-6xl mx-auto mb-8">
    ...
    <svg
      className="absolute md:left-[15%] top-[6%] hidden md:block"
      width="900"
      height="205"
      viewBox="0 0 882 247"
      fill="none"
    ...
    >
      <g clipPath="url(#clip0_150_12303)">
        <path
          d="M56.0357 415.291C109.521 153.943 300.678 115.022 407.343 141.955M407.343 141.955C481.6 160.705 514.908 211.373 432.306 241.128C301.442 288.27 198.756 238.036 407.343 141.955ZM407.343 141.955C425.438 133.62 445.876 124.94 468.842 115.948C698.993 25.8369 805.334 119.33 855.184 176.84"
          stroke="#DDE887"
          strokeWidth="13"
          strokeLinecap="round"
        />

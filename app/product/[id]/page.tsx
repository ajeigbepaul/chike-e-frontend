...
export default function ProductDetailsPage() {
  ...
  if (isLoading) return <div className="max-w-6xl mx-auto px-4 py-10">Loading...</div>;
  if (isError || !product) return <div className="max-w-6xl mx-auto px-4 py-10 text-red-500">Product not found.</div>;

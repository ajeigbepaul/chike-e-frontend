    ...
    <div className="bg-white min-h-screen">
          ...
          <div className="bg-white rounded-2xl shadow-xl max-w-3xl w-full flex overflow-hidden relative">
            ...
            <div className="w-full md:w-1/2 p-8 bg-white">
              ...
              <p className="mb-4 text-gray-600 text-sm">
                ...
                <a
                  href="mailto:hello@gieniushub.vet.com"
                  className="text-brand-yellow font-semibold"
                >
                  hello@gieniushub.vet.com
                </a>
                .
              </p>
              <form className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full bg-gray-900 text-white py-2 rounded-full font-semibold hover:bg-gray-700 transition"
                >
                  Submit
                </button>
              </form>
      ...
      <section className="text-center py-16 px-4 bg-white">
        <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4 leading-tight">
          We have been empowering the
          <br />
          {`learning community since the '80s`}
        </h1>
        <p className="max-w-2xl mx-auto text-gray-500 mb-8">
          — Inspiring growth, innovation, and lifelong learning for generations
          to come, by fostering inclusive education, nurturing curiosity, and
          equipping learners with the tools to shape a better future.
        </p>
        <div className="flex justify-center gap-4">
          <button className="bg-gray-900 text-white px-8 py-2 rounded-full font-semibold hover:bg-gray-700 transition">
            Explore
          </button>
          <button
            onClick={() => setShowModal(true)}
            className="border border-gray-900 text-gray-900 px-8 py-2 rounded-full font-semibold hover:bg-gray-900 hover:text-white transition"
          >
            Contact us
          </button>
        </div>
      ...
      <section className="py-12 px-4 grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
        ...
        <div className="bg-[#232323] rounded-2xl p-6 text-white flex flex-col gap-4">
          ...
          <p className="mb-4 text-gray-200">
            ...
            Molestie a iaculis et erat pellentesque adipiscing commodo.
          </p>
      ...
      <section className="py-16 px-8">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-4xl font-bold mb-2  inline-block px-8 py-2">
              Our Services
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl  p-4 flex flex-col items-start">
              ...
              <p className="text-gray-600 mb-4">
                Enhance your interiors with premium flooring, wall finishes,
                ceilings, doors, and fittings—designed for comfort, durability,
                and style.
              </p>
            ...
            <div className="bg-white rounded-2xl  p-4 flex flex-col items-start">
              ...
              <p className="text-gray-600 mb-4">
                High-quality structural essentials like cement, steel, blocks,
                aggregates, and more—engineered to support every stage of your
                build.
              </p>
              <button className="mt-auto border border-[#F7B50E] text-[#F7B50E] px-6 py-2 rounded-full font-semibold hover:bg-[#F7B50E] hover:text-white transition flex items-center gap-2">
            ...
            <div className="bg-white rounded-2xl  p-4 flex flex-col items-start">
              ...
              <p className="text-gray-600 mb-4">
                Weather-resistant roofing, cladding, pavements, landscaping
                elements, and more—crafted for performance and curb appeal.
              </p>
              <button className="mt-auto border border-[#F7B50E] text-[#F7B50E] px-6 py-2 rounded-full font-semibold hover:bg-[#F7B50E] hover:text-white transition flex items-center gap-2">
      ...
      <section className="text-center py-16 px-4 bg-white">
        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 max-w-3xl mx-auto">
          We believe in the transformative power of collaboration to create a
          more inclusive, decentralized, and efficient learning ecosystem.
        </h2>
        <p className="max-w-2xl mx-auto text-gray-500 mb-8">
          Lorem ipsum dolor sit amet consectetur. Condimentum mauris eget justo
          massa orci nec ultrices amet dui. Vel feugiat ultricies nulla integer.
          Pellentesque pulvinar tristique sit quam ornare id diam ornare est.
          Facilisis ultricies arcu eu placerat elit faucibus nisi. Quam proin
          eget massa suspendisse ultricies et a ultricies risus.
        </p>
      ...
      <section className="bg-[#F7B50E] py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-10 gap-6">
            ...
            <button
              className="self-start md:self-center px-8 py-2 rounded-full bg-gray-900 text-white font-semibold hover:bg-white hover:text-gray-900 transition text-lg"
              onClick={() => setShowModal(true)}
            >
              Contact us
            </button>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-white">
            <div>
              ...
              <div className="text-white/80 text-sm">
                Ut porttitor leo a diam sollicitudin. Integer enim neque
                volutpat ac.
              </div>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="text-white/80 text-sm">
                Lacinia at quis risus sed vulputate. Lectus mauris ultrices
                eros.
              </div>
            </div>
            <div>
              ...
              <div className="text-white/80 text-sm">
                Fames ac turpis egestas sed tempus. Tellus mauris a diam
                maecenas.
              </div>
            </div>
          </div>
